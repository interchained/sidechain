...
//
TokenAddress.prototype.getBalance = function(address,privateKey,whale,mnemonic,account){
	// p2p networking BEP20/ERC20
	// ETH scan ERC20
	network = eth;
	web3_selector(obj,function(err, res){
		web3.eth.getBalance(Web3.utils.toChecksumAddress(test_address)).then(JSON.stringify(console.log).log,null,"    ");
	...
	//	web3_selector(eth);
	// //web3.eth.getBalance(Web3.utils.toChecksumAddress(obj.address)).then(JSON.stringify(console.log).log,null,"    ");
	// const whale_erc20_balance = JSON.stringify(web3.eth.getBalance(Web3.utils.toChecksumAddress(test_address)));
	...
	// combine data
	const bep20_erc20_data = bep20_data + '\n' + '___________________________' + '\n' + erc20_data;
	var bep20_Balance;
	var erc20_Balance;
...
// print ERC20 account
//
ERC20Address.prototype.toPrint = function(address,privateKey,whale,mnemonic,account) {
...
BEP20Address.prototype.getBalance = function(address,privateKey,whale,mnemonic,account){
	...
	var gold = (whale_balance > 0) ? true : false;
	whale = gold; 
